...
# Real-world correction: move foot and knee together during the lift. Keep this
# moderate so the knees do not pull inward far enough to hit the body.
FOOT_DOWN_EXTRA_DURING_LIFT = -12.0
KNEE_IN_EXTRA_DURING_LIFT = -12.0
